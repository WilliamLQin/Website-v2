...
export const TILES: GridTile[] = [
    
    {
        ...
        imagePath: "/assets/img/Icon Hexes/Hex_Resume.svg",
        hoverPath: "/assets/img/Overlay Hexes/Hex_Overlay Hex Size 3.svg",
        mainPath: "/assets/img/Main Hexes/Hex_Resume Main.png",
        title: "Resume",
        description: "View my resume.",
        targetURL: "href=../assets/downloads/WilliamQin-resume.pdf",
        hovering: false
    }
    // ,{
    //     index: 1,
